    ...
    def test_dependency_lock_is_exact_and_restricted(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                "client_character_creation_command.fbs",
                "client_dialogue_choice_command.fbs",
                "client_hello.fbs",
                ...
                "latest_wins_equipment_snapshot.fbs",
                "latest_wins_snapshot.fbs",
                "reliable_actor_interest_baseline.fbs",
                "reliable_combat_event_batch.fbs",
                "reliable_character_profile.fbs",
                "reliable_dialogue_choice_result.fbs",
                "reliable_container_inventory_baseline.fbs",
                "reliable_ground_item_baseline.fbs",
                "reliable_interactive_object_interest_baseline.fbs",
