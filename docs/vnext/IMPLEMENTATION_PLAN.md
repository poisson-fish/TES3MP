...
| 6.2 | Map reliable operations and latest-wins snapshots to explicit transport channels | **In Progress** | Owner-approved [`ADR-0033`](adr/ADR-0033-phase6-transport-channel-and-delivery-semantics.md); implementation `2f022fe4ad` and applicable local verification pass, with owner implementation-demo acceptance still required |
