...
| ADR-0055 | Phase 9 optional VR pose capability and schema | Phase 9 | **Proposed** |
...
| 9.3 | Add optional `vr_pose` capability and bounded head/hand pose snapshot schema | **Not Started** | Proposed ADR-0055 awaits owner approval; no production schema code has started |
