...
| 9.2 | Build the same adapter/client-session targets against desktop and PC VR engines | **In Progress** | ADR-0054 Option A and its acceptance tests are approved; implementation and verification remain |
