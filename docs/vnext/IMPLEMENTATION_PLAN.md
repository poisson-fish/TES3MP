...
| 7.4 | Implement one interior and one exterior cell fixture plus enter/leave observation | **In Progress** | Accepted [`ADR-0043`](adr/ADR-0043-phase7-fixture-cell-transition-and-observation.md); typed fixture-transition intake and atomic canonical reducer behavior for known, unknown, and same-cell requests pass the full independent contract target; protocol exchange, observation projection/delivery, and real-process demo remain |
