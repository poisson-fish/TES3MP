...
| 6.2 | Map reliable operations and latest-wins snapshots to explicit transport channels | **In Progress** | Owner-approved [`ADR-0033`](adr/ADR-0033-phase6-transport-channel-and-delivery-semantics.md); implementation and local verification are in progress, with owner demo acceptance still required |
