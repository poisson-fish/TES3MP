...
| 7.6 | Implement disconnect, bounded grace period, resume, and clean expiration | **In Progress** | Accepted [`ADR-0045`](adr/ADR-0045-phase7-disconnect-resume-and-expiration-composition.md); prepared resume-token rotation plus transactional canonical hide/resume/expiration and focused contracts pass; live authentication/output/process composition remains |
