...
| 7.4 | Implement one interior and one exterior cell fixture plus enter/leave observation | **In Progress** | Accepted [`ADR-0043`](adr/ADR-0043-phase7-fixture-cell-transition-and-observation.md); typed fixture-transition command/reducer and distinct bounded reliable observation-batch codec pass focused contracts; projection/delivery, client application, and real-process demo remain |
