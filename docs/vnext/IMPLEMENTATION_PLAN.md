...
| 7.4 | Implement one interior and one exterior cell fixture plus enter/leave observation | **Not Started** | Accepted [`ADR-0043`](adr/ADR-0043-phase7-fixture-cell-transition-and-observation.md) defines the reliable reducer path, explicit observation changes, fixed fixtures, atomic publication, and acceptance tests; implementation has not started |
