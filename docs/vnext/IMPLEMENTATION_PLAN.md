...
| 7.6 | Implement disconnect, bounded grace period, resume, and clean expiration | **In Progress** | Accepted [`ADR-0045`](adr/ADR-0045-phase7-disconnect-resume-and-expiration-composition.md); prepared token rotation, canonical lifecycle transactions, live join registration, and failure-atomic disconnect hide/output composition pass focused contracts; resume authentication/output, expiration pumping, and process proof remain |
