...
| 7.5 | Implement semantic movement commands and sequenced snapshots | **In Progress** | Accepted [`ADR-0044`](adr/ADR-0044-phase7-movement-tick-and-snapshot-composition.md); atomic checked integration, live motion dispatch, complete targeted views, focused tests, and the real two-client movement/convergence/stale-view proof pass; owner demo acceptance pending |
