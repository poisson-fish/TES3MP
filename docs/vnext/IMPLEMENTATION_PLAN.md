...
| 6.6 | Integrate real sockets into the deterministic fault harness | **In Progress** | Owner-approved [`ADR-0039`](adr/ADR-0039-phase6-deterministic-real-transport-fault-boundary.md); localhost tests exercise faults above/below the adapter as supported |
