...
| 7.4 | Implement one interior and one exterior cell fixture plus enter/leave observation | **In Progress** | Accepted [`ADR-0043`](adr/ADR-0043-phase7-fixture-cell-transition-and-observation.md); transition/reducer, observation codec, deterministic projection/admission, and bounded atomic client application pass focused contracts; runtime composition and real-process demo remain |
