...
| 7.6 | Implement disconnect, bounded grace period, resume, and clean expiration | **In Progress** | Accepted [`ADR-0045`](adr/ADR-0045-phase7-disconnect-resume-and-expiration-composition.md); implementation `9c75892eb1`, focused contracts, and the real two-client disconnect/resume/expiration proof pass; owner demo acceptance remains |
