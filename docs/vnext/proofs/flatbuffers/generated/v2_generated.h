...
#ifndef FLATBUFFERS_GENERATED_V2_VNEXT_PROOF_V2_H_
#define FLATBUFFERS_GENERATED_V2_VNEXT_PROOF_V2_H_
...
template<> struct PayloadTraits<vnext::proof::v2::Motion> {
...
struct Motion FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  vnext::proof::v2::TravelMode mode() const {
    return static_cast<vnext::proof::v2::TravelMode>(GetField<uint8_t>(VT_MODE, 0));
  }
  template <bool B = false>
...
struct MotionBuilder {
  ...
  void add_mode(vnext::proof::v2::TravelMode mode) {
...
inline ::flatbuffers::Offset<Motion> CreateMotion(
    ...
    vnext::proof::v2::TravelMode mode = vnext::proof::v2::TravelMode::Unknown) {
...
inline ::flatbuffers::Offset<Motion> CreateMotionDirect(
  ...
  return vnext::proof::v2::CreateMotion(
      _fbb,
      name__,
      samples__,
      mode);
...
struct Envelope FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  vnext::proof::v2::Payload payload_type() const {
    return static_cast<vnext::proof::v2::Payload>(GetField<uint8_t>(VT_PAYLOAD_TYPE, 0));
  }
  const void *payload() const {
    return GetPointer<const void *>(VT_PAYLOAD);
  }
  template<typename T> const T *payload_as() const;
  const vnext::proof::v2::Motion *payload_as_Motion() const {
    return payload_type() == vnext::proof::v2::Payload::Motion ? static_cast<const vnext::proof::v2::Motion *>(payload()) : nullptr;
  }
...
template<> inline const vnext::proof::v2::Motion *Envelope::payload_as<vnext::proof::v2::Motion>() const {
...
struct EnvelopeBuilder {
  ...
  void add_payload_type(vnext::proof::v2::Payload payload_type) {
  ...
  void add_capability(::flatbuffers::Offset<::flatbuffers::String> capability) {
    fbb_.AddOffset(Envelope::VT_CAPABILITY, capability);
  }
...
inline ::flatbuffers::Offset<Envelope> CreateEnvelope(
    ...
    uint64_t sequence = 0,
    vnext::proof::v2::Payload payload_type = vnext::proof::v2::Payload::NONE,
...
inline ::flatbuffers::Offset<Envelope> CreateEnvelopeDirect(
  ...
  return vnext::proof::v2::CreateEnvelope(
      _fbb,
      protocol_version,
      sequence,
      payload_type,
...
inline bool VerifyPayload(::flatbuffers::VerifierTemplate<B> &verifier, const void *obj, Payload type) {
  switch (type) {
    ...
    case Payload::Motion: {
      auto ptr = reinterpret_cast<const vnext::proof::v2::Motion *>(obj);
...
inline const vnext::proof::v2::Envelope *GetEnvelope(const void *buf) {
  return ::flatbuffers::GetRoot<vnext::proof::v2::Envelope>(buf);
}

inline const vnext::proof::v2::Envelope *GetSizePrefixedEnvelope(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<vnext::proof::v2::Envelope>(buf);
}
...
inline bool VerifyEnvelopeBuffer(
  ...
  return verifier.template VerifyBuffer<vnext::proof::v2::Envelope>(EnvelopeIdentifier());
}

template <bool B = false>
inline bool VerifySizePrefixedEnvelopeBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<vnext::proof::v2::Envelope>(EnvelopeIdentifier());
}
...
inline void FinishEnvelopeBuffer(
    ...
    ::flatbuffers::Offset<vnext::proof::v2::Envelope> root) {
...
#endif  // FLATBUFFERS_GENERATED_V2_VNEXT_PROOF_V2_H_
