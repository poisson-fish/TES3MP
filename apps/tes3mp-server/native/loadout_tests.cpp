...
int main(int argc, char** argv)
{
    try
    {
        ...
        if (argc == 5 && std::string_view(argv[1]) == "npc-strike-enchantment")
        {
            TES3MP::Native::Testing::checkNpcDoors(std::filesystem::absolute(argv[2]),
                std::filesystem::absolute(argv[3]), std::filesystem::absolute(argv[4]),
                true, true, true, true, true, false, false, false, false, false, false, true);
            std::cout << "PASS npc-strike-enchantment\n"; return 0;
        }
        ...
        if (argc == 5 && std::string_view(argv[1]) == "npc-life-cycle")
        {
            TES3MP::Native::Testing::checkNpcDoors(std::filesystem::absolute(argv[2]),
                std::filesystem::absolute(argv[3]), std::filesystem::absolute(argv[4]),
                true, true, true, true, true);
            std::cout << "PASS npc-life-cycle\n"; return 0;
        }
        if (argc == 5 && std::string_view(argv[1]) == "npc-instant-spell")
        {
            TES3MP::Native::Testing::checkNpcDoors(std::filesystem::absolute(argv[2]),
                std::filesystem::absolute(argv[3]), std::filesystem::absolute(argv[4]),
                true, true, true, true, true, true);
            std::cout << "PASS npc-instant-spell\n"; return 0;
        }
        if (argc == 5 && std::string_view(argv[1]) == "npc-target-spell")
        {
            TES3MP::Native::Testing::checkNpcDoors(std::filesystem::absolute(argv[2]),
                std::filesystem::absolute(argv[3]), std::filesystem::absolute(argv[4]),
                true, true, true, true, true, true, true);
            std::cout << "PASS npc-target-spell\n"; return 0;
        }
        if (argc == 5 && std::string_view(argv[1]) == "npc-timed-spell")
        {
            TES3MP::Native::Testing::checkNpcDoors(std::filesystem::absolute(argv[2]),
                std::filesystem::absolute(argv[3]), std::filesystem::absolute(argv[4]),
        ...
        if (argc == 5 && std::string_view(argv[1]) == "npc-general-constants")
        {
            TES3MP::Native::Testing::checkNpcDoors(std::filesystem::absolute(argv[2]),
                std::filesystem::absolute(argv[3]), std::filesystem::absolute(argv[4]),
                true, true, true, true, true, true, true, true,
                false, false, false, false, false, false, false, true, true, true);
            std::cout << "PASS npc-general-constants\n"; return 0;
        }
        ...
        if (argc == 5 && std::string_view(argv[1]) == "player-target-spell")
        {
            TES3MP::Native::Testing::checkNpcDoors(std::filesystem::absolute(argv[2]),
                std::filesystem::absolute(argv[3]), std::filesystem::absolute(argv[4]),
                true, true, true, true, true, true, true, true, true, true);
            std::cout << "PASS player-target-spell\n"; return 0;
        }
        if (argc == 5 && std::string_view(argv[1]) == "concurrent-projectiles")
        {
            TES3MP::Native::Testing::checkNpcDoors(std::filesystem::absolute(argv[2]),
                std::filesystem::absolute(argv[3]), std::filesystem::absolute(argv[4]),
