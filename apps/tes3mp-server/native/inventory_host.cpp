    ...
    namespace
    {
            ...
            const PlayerIdentityRegistry& players)
        {
            ...
            if (movingActor)
            {
                ...
                if (version == "native-inventory-25" || version == "native-inventory-26" || version == "native-inventory-27" || version == "native-inventory-28" || version == "native-inventory-29" || version == "native-inventory-30" || version == "native-inventory-31" || version == "native-inventory-32" || version == "native-inventory-33" || version == "native-inventory-34")
                {
            ...
            if (version == "native-inventory-28" || version == "native-inventory-29" || version == "native-inventory-30" || version == "native-inventory-31" || version == "native-inventory-32" || version == "native-inventory-33" || version == "native-inventory-34")
            {
                ...
                binding.mMagicTimed = version == "native-inventory-29" || version == "native-inventory-30" || version == "native-inventory-31" || version == "native-inventory-32" || version == "native-inventory-33" || version == "native-inventory-34";
                binding.mMagicArea = version == "native-inventory-30" || version == "native-inventory-31" || version == "native-inventory-32" || version == "native-inventory-33" || version == "native-inventory-34";
                binding.mMagicPlayerTarget = version == "native-inventory-31" || version == "native-inventory-32" || version == "native-inventory-33" || version == "native-inventory-34";
                binding.mMagicProjectileCollection = version == "native-inventory-32" || version == "native-inventory-33" || version == "native-inventory-34";
                binding.mKnockoutRules = version == "native-inventory-33" || version == "native-inventory-34";
                binding.mMeleeDefenseRules = version == "native-inventory-34";
            }
