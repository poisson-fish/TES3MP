    ...
    namespace
    {
            ...
            const PlayerIdentityRegistry& players)
        {
            ...
            if (movingActor)
            {
                ...
                if (version == "native-inventory-25" || version == "native-inventory-26" || version == "native-inventory-27" || version == "native-inventory-28" || version == "native-inventory-29" || version == "native-inventory-30" || version == "native-inventory-31" || version == "native-inventory-32")
                {
            ...
            if (version == "native-inventory-28" || version == "native-inventory-29" || version == "native-inventory-30" || version == "native-inventory-31" || version == "native-inventory-32")
            {
                ...
                binding.mMagicTimed = version == "native-inventory-29" || version == "native-inventory-30" || version == "native-inventory-31" || version == "native-inventory-32";
                binding.mMagicArea = version == "native-inventory-30" || version == "native-inventory-31" || version == "native-inventory-32";
                binding.mMagicPlayerTarget = version == "native-inventory-31" || version == "native-inventory-32";
                binding.mMagicProjectileCollection = version == "native-inventory-32";
            }
