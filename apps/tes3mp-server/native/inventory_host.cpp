    ...
    namespace
    {
            ...
            const PlayerIdentityRegistry& players)
        {
            ...
            if (movingActor)
            {
                ...
                if (version == "native-inventory-25" || version == "native-inventory-26" || version == "native-inventory-27" || version == "native-inventory-28" || version == "native-inventory-29" || version == "native-inventory-30" || version == "native-inventory-31")
                {
            ...
            if (version == "native-inventory-28" || version == "native-inventory-29" || version == "native-inventory-30" || version == "native-inventory-31")
            {
                ...
                binding.mMagicTimed = version == "native-inventory-29" || version == "native-inventory-30" || version == "native-inventory-31";
                binding.mMagicArea = version == "native-inventory-30" || version == "native-inventory-31";
                binding.mMagicPlayerTarget = version == "native-inventory-31";
            }
