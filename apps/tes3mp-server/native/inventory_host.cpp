...
namespace TES3MP::Native
{
    namespace
    {
            ...
            const PlayerIdentityRegistry& players)
        {
            ...
            if (version == "native-inventory-28" || version == "native-inventory-29" || version == "native-inventory-30" || version == "native-inventory-31" || version == "native-inventory-32" || version == "native-inventory-33" || version == "native-inventory-34" || version == "native-inventory-35")
            {
                ...
                binding.mMagicTimed = version == "native-inventory-29" || version == "native-inventory-30" || version == "native-inventory-31" || version == "native-inventory-32" || version == "native-inventory-33" || version == "native-inventory-34" || version == "native-inventory-35";
                binding.mMagicArea = version == "native-inventory-30" || version == "native-inventory-31" || version == "native-inventory-32" || version == "native-inventory-33" || version == "native-inventory-34" || version == "native-inventory-35";
                binding.mMagicPlayerTarget = version == "native-inventory-31" || version == "native-inventory-32" || version == "native-inventory-33" || version == "native-inventory-34" || version == "native-inventory-35";
                binding.mMagicProjectileCollection = version == "native-inventory-32" || version == "native-inventory-33" || version == "native-inventory-34" || version == "native-inventory-35";
                binding.mKnockoutRules = version == "native-inventory-33" || version == "native-inventory-34" || version == "native-inventory-35";
                binding.mMeleeDefenseRules = version == "native-inventory-34" || version == "native-inventory-35";
                binding.mActorEffectLifecycle = version == "native-inventory-35";
            }
