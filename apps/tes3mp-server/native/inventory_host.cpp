...
namespace TES3MP::Native
{
    namespace
    {
            ...
            const PlayerIdentityRegistry& players)
        {
            ...
            binding.mMeleeContact = version == "native-inventory-22" || version == "native-inventory-23";
            binding.mCombatState = version == "native-inventory-23";
