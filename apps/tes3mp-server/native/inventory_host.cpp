    ...
    namespace
    {
            ...
            const PlayerIdentityRegistry& players)
        {
            ...
            if (movingActor)
            {
                ...
                if (version == "native-inventory-25" || version == "native-inventory-26" || version == "native-inventory-27" || version == "native-inventory-28")
                {
            ...
            if (version == "native-inventory-28")
            {
