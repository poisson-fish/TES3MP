...
{
    class Loadout;
    // Read-only OpenMW model scene for the currently bound cell. This target
    ...
    public:
        PlacementScene(Loadout& loadout, ESM::RefId cell, std::span<const ESM::CellRef> worldDomain);
        ~PlacementScene();
