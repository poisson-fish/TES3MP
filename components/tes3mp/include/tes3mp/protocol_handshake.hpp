...
namespace TES3MP
{
    ...
    inline constexpr CapabilityId inventoryReplicationCapability() noexcept
    {
        return *CapabilityId::fromValue(InventoryReplicationCapabilityValue);
    }
    ...
    inline constexpr CapabilityId nativeActorMotionCapability() noexcept
    { return *CapabilityId::fromValue(NativeActorMotionCapabilityValue); }
    ...
    {
        return *CapabilityId::fromValue(NativeEnvironmentCapabilityValue);
    }
    ...
    inline constexpr CapabilityId dialogueChoiceCapability() noexcept
    {
        return *CapabilityId::fromValue(DialogueChoiceCapabilityValue);
    }
    ...
    inline constexpr CapabilityId authoritativeWaitRestCapability() noexcept
    {
        return *CapabilityId::fromValue(AuthoritativeWaitRestCapabilityValue);
    }

    inline constexpr CapabilityId authoritativeSecurityCapability() noexcept
    {
        return *CapabilityId::fromValue(AuthoritativeSecurityCapabilityValue);
    }
